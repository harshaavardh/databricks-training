...
from Employees group by department having count(department)>3;
select department , avg(salary)
from Employees group by department having avg(salary)>60000;
select city , count(city)
from Employees group by city having count(city) > 2;
select department , sum(salary) as tot_salary
from Employees group by department having tot_salary >200000;
select department , max(salary) as max_salary
from Employees group by department having max_salary >90000;
